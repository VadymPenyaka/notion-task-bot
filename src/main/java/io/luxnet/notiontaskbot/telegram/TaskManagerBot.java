...
public class TaskManagerBot extends TelegramLongPollingBot {
    ...
    public TaskManagerBot(DefaultBotOptions botOptions, TelegramProperties telegramProperties, List<UpdateHandler> handlers) {
        super(botOptions, telegramProperties.getToken());
